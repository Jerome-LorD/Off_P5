...
CREATE TABLE IF NOT EXISTS `offdb`.`categories` (
  ...
  `name` VARCHAR(120) NULL DEFAULT NULL UNIQUE,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `offdb`.`nutriscore` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `type` VARCHAR(1) NULL DEFAULT NULL UNIQUE,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `offdb`.`products` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(80) NULL DEFAULT NULL UNIQUE,
...
CREATE TABLE IF NOT EXISTS `offdb`.`categories_products` (
  ...
  INDEX `fk_categories_products_products_idx` (`products_id` ASC),
  INDEX `fk_categories_products_categories_idx` (`categories_id` ASC),
